...
from gpt_lora import ContinuousPromptLearning
...
parser.add_argument('-llm_model', '--llm_model', type=str, default="./llm/models-gpt2",
                    help='llm model')
parser.add_argument('-lora_nums', '--lora_nums', type=str, default="10,11",
...
model = ContinuousPromptLearning.from_pretrained(args.llm_model, nuser, nitem, args.lora_nums, args.lora_dim,
                                                 args.nhead, tokenizer.pad_token_id)
